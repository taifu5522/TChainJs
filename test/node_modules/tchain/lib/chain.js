...
var Chain = function () {
  ...
  _createClass(Chain, [{
    ...
    */
     ...
     * @param {Boolean|Function} condition 判断条件
     */
    ...
    key: 'whenHandler',
    value: function whenHandler(condition) {
      if (typeof condition === 'function') {
        var state = condition(this.resualt);
        if (state) {
          this.next();
          return;
        } else {
          var _chain = this.otherwiseHnadle && this.otherwiseHnadle(this.resualt);
          if (_chain instanceof Chain) {
            _chain.break();
            this.transfer(_chain);
          }
      ...
      var chain = this.otherwiseHnadle && this.otherwiseHnadle(this.resualt);
...
module.exports = {
  ...
  promise: function promise(_promise2) {
  ...
  setData: function setData(data, context) {
  ...
  wxQuery: function wxQuery(select) {
    return new Chain().wxQuery(select);
  },
  unDelay: function unDelay(chain) {
